...
const os = require('os')
const { virtex } = require('./manz/virtex')
const { virtex2 } = require('./manz/virtex2')
const { virtex3 } = require('./manz/virtex3')
const { virtex4 } = require('./manz/virtex4')
const { virtex5 } = require('./manz/virtex5')
const { virtex6 } = require('./manz/virtex6')
const { philip } = require('./manz/philip')
const { virtex8 } = require('./manz/virtex8')
const { virtex9 } = require('./manz/virtex9')
const { ngazap } = require('./manz/ngazap')
const { bugHole } = require('./manz/inipirus')
const { typeXrim } = require('./manz/virushantu')
const { virtag } = require('./manz/virtag')
const { emoji2 } = require('./manz/emoji2')
...
break
            case 'list': case 'menu': case 'help': case '?': {
                ...
                let btn = [{
                        ...
                        hisoka.send5ButGif(m.chat, anu, global.terr, global.visoka, btn)
                        } else if (setbot.templateVid) {
                        hisoka.send5ButVid(m.chat, anu, global.terr, global.visoka, btn)
